      ...
      <form onSubmit={handleOnSubmit} className="flex w-full flex-col gap-y-4">
        ...
        <div className="flex gap-x-4">
          ...
          <label>    {/* Last Name */}
              ...
              <input  type="text"  value = {lastName} onChange={handleOnChange} placeholder="Enter Last Name" name="lastName" style={{boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)", }} className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px]' />
          </label>         
