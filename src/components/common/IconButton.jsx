export default function IconBtn({text, onclick, children, disabled, outline = false, customClasses, type,}){
  ...
  return (
    ...
    <button disabled = {disabled} onClick = {onclick} className = {`flex items-center  justify-center cursor-pointer gap-x-2 rounded-md py-2 px-5 font-semibold text-richblack-900
